...
@pytest.fixture(scope="module")
def token0(pool_initialized, token_a, token_b, sender, callee, router, spot_reserve0):
...
@pytest.fixture(scope="module")
def token1(pool_initialized, token_a, token_b, sender, callee, router, spot_reserve1):
