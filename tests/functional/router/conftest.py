...
def token0_with_WETH9(
    pool_with_WETH9, token_a, WETH9, sender, callee, router, spot_reserve0, chain
):
...
def token1_with_WETH9(
    pool_with_WETH9, token_a, WETH9, sender, callee, router, spot_reserve1, chain
):
...
def pool_with_WETH9_initialized_with_liquidity(
    ...
    pool_with_WETH9.approve(router.address, 2**256 - 1, sender=sender)
