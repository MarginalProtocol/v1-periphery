...
@pytest.fixture(scope="module")
def token0(pool, token_a, token_b, sender, callee, initializer, manager, spot_reserve0):
...
@pytest.fixture(scope="module")
def token1(pool, token_a, token_b, sender, callee, initializer, manager, spot_reserve1):
