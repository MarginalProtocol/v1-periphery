...
def test_viewer_get_position_info_synced__returns_position_info(
    oracle_lens,
    position_viewer,
    manager,
    ...
    result = position_viewer.getPositionInfoSynced(
        position.pool, manager.address, position.positionId
    )
    viewer_position_info = (
        position.zeroForOne,
        position.size,
        position.debt,
        position.margin,
    ...
    assert result == viewer_position_info
