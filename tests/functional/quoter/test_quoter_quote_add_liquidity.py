...
def test_quoter_quote_add_liquidity__quotes_liquidity_add_when_no_liquidity(
    pool_initialized,
    quoter,
    router,
    manager,
    ...
    params = (
        pool_initialized.token0(),
        pool_initialized.token1(),
        pool_initialized.maintenance(),
        pool_initialized.oracle(),
        alice.address,
        amount0_desired,
        amount1_desired,
        amount0_min,
    ...
    shares = pool_initialized.balanceOf(alice.address) - shares_alice
    assert result.shares == shares
